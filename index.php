...
<body>
    ...
    <!-- nav -->
    <?php include('home/layout/nav.php')?>
    <!-- section -->
    <div class="container">
        <div class="section">
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div class="row">
                        ...
                        ?>
                        <div class="col-md-4">
                        <a href="home/page/chitiet.php?idtintuc=<?php echo $row['id']?>"><img src="align/image/<?php echo $row['hinhanh']?>" width="170px" height="130px" alt=""></a>
                            <h4><a href="home/page/chitiet.php?idtintuc=<?php echo $row['id']?>"><?php echo $row['tieude']?></a></h4>
                        </div>
                               <?php }}?>
                    </div>
